...
slug: contributing/guides/getting-started
---

Lucia is an auth library for your server that abstracts away the complexity of handling sessions. It works alongside your database to provide an API that's easy to use, understand, and extend. [Get started →](/contributing/getting-started)
